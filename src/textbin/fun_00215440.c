...
struct Tracks { u8 pad[0x1618]; s32 h[1][2]; };
...
void FUN_00215440(s32 arg0, s32 arg1, s32 arg2) {
    s32 temp_4_14;
...
extern __typeof__(FUN_00215440) func_00215440 __attribute__((alias("FUN_00215440")));
