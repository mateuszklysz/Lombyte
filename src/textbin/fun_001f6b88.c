...
/* ROLE: recovered function `FontPrintCenterSmall` starts here; this unit covers only its beginning. */
...
extern __typeof__(FUN_001f6b88) func_001F6B88 __attribute__((alias("FUN_001f6b88")));
