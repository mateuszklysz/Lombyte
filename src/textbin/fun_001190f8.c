...
/* ROLE: DisableDmac: interrupt-guarded public wrapper over the `_DisableDmac` kernel entry (callee and guard-pattern evidence). */
...
extern __typeof__(FUN_001190f8) DisableDmac __attribute__((alias("FUN_001190f8")));
