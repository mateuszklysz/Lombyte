...
void patch_tie_texture_fields(void) __asm__("FUN_00235780");

void patch_tie_texture_fields(void) {
    s32 *p;
    s32 i;
    struct Obj *o;
    struct Part *q;
...
extern __typeof__(patch_tie_texture_fields) func_00235780 __attribute__((alias("FUN_00235780")));
