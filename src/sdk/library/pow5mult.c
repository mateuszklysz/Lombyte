 ...
 * build/workspace/rnc-refval/campaigns/pipeline-2026-09-08-3/tier2-20260909/finalists/pow5mult/validation.json
 */
/****************************************************************
 *
...
extern s32 D_001523B8[];
extern _Bigint *func_00115808(struct _reent *, s32);
extern _Bigint *_multiply(struct _reent *, _Bigint *, _Bigint *);
...
_pow5mult(struct _reent *ptr, _Bigint *b, s32 k)
{
    ...
    if (!(k >>= 2))
        return b;
    if (!(p5 = ptr->_p5s)) {
        p5 = ptr->_p5s = func_00115808(ptr, 625);
        p5->_next = 0;
    }
    for (;;) {
        if (k & 1) {
