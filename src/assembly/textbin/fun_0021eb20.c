/* ROLE: recovered function `DrawItemsMenu` (game/pause.cpp, 0x458 bytes) starts here; this unit covers only its first fragment. */
...
void *FUN_0021eb20(int slot, int type) {
    char *r;
