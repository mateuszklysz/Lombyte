...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_001fa070/FUN_001fa070.s", FUN_001fa070);
#else
#include "rnc/assembly_textbin_fun_001fa070_types.h"
#include "types.h"
...
int FUN_001fa070(char *s0, unsigned char n, char *s2) {
    char *obj;
    char *vt;
    int (*fp)();
    float r;
