...
SYMBOL: SoundOptionsMenu
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `SoundOptionsMenu`. */

#include "types.h"
#include "asm.h"

#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/sound_options_menu/FUN_0021cb30.s", FUN_0021cb30);
#else
#include "types.h"
...
void FUN_0021cb30(void *a0, int a1) {
    char *s0 = (char *)a0;
    volatile int s1 = a1;
    void *m;
    int val;
