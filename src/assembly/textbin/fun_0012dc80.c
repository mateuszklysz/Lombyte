...
SYMBOL: snd_FlushSoundCommands
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered function `snd_FlushSoundCommands` starts here; this unit covers only its beginning. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0012dc80/FUN_0012dc80.s", FUN_0012dc80);
#else
#include "types.h"
...
void FUN_0012dc80(void *a0, int a1) {
    char *s0 = (char *)a0;
    int s1 = a1;
    void *m;
    int val;
