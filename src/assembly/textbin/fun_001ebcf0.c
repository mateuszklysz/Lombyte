...
SYMBOL: ExecuteCamPostUpdFuncs
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered function `ExecuteCamPostUpdFuncs` starts here; this unit covers only its beginning. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_001ebcf0/FUN_001ebcf0.s", FUN_001ebcf0);
#else
#include "types.h"
