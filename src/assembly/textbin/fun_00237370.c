/* ROLE: recovered function `LightTies` (tieproc) starts here; recovered extent unknown. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_00237370/FUN_00237370.s", FUN_00237370);
#else
#include "types.h"
