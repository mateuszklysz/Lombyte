/* ROLE: recovered function `snd_ResolveBankXREFS` (snd989, 0x30 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0012e1a8/FUN_0012e1a8.s", FUN_0012e1a8);
#else
#include "types.h"
