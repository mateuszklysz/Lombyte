...
SYMBOL: LoadingDataMenu
SCORE: code=78.15847 functions=78.15847 data=100 complete_data=100
DECISION: retained
...
s32 FUN_002232d8(struct M2c_arg0 *arg0) {
    ...
    if (D_001D5BF0.unk128 != 0) {
        if ((D_0013D290.unkD4 < 3) && (D_0013D290.unkDC < 0)) {
            ...
            D_0013D290.unkF4 = 1;
            temp_lo_45 = (s32) (D_0015EDF0 * 8) / 10;
            D_0013E550.unk4C = (s32) D_0015EDEC;
            temp_lo_57 = (s32) (D_0015EDF0 * 7) / 10;
            D_0013E550.unk48 = temp_lo_45;
            D_0013E550.unk50 = temp_lo_45;
            D_0013E550.unk54 = temp_lo_57;
            D_0013E550.unk5C = (s32) D_0015EDF0;
            D_0013E550.unk58 = temp_lo_57;
            InitializeGlobalStateEntry(D_0015ED84, &D_0013E550, D_0015EDF0, 0xA, 0xA, temp_lo_45);
            D_0013E05A = 0;
            goto block_6;
        }
...
block_10:
    if (D_0013C940.unk1C4 & 0x10) {
        temp_2_90 = D_001D5BF0.unk4->unk38;
        if (temp_2_90 != 0) {
            D_001D5BF0.unk8 = temp_2_90;
            goto block_16;
        }
        if (D_001D5BF0.unk124 == 0) {
            return -1;
...
block_17:
    ...
    if ((D_0013D290.unkD4 < 3) && (D_0013D290.unkDC < 0) && (D_0013D290.unk8 == 2)) {
        if (arg0->unk30 & 1) {
            var_3_132 = D_0013C940.unk1B4;
        } else {
            var_3_132 = D_0013C940.unk1C4;
        }
        arg0->unk40 = (s32) D_0015EE34;
        if ((var_3_132 & 0x1000) && (D_0015EE34 != 0)) {
            arg0->unk40 = (s32) (D_0015EE34 - 1);
        }
        temp_4_147 = arg0->unk40;
        if ((var_3_132 & 0x4000) && (temp_4_147 < 4)) {
            arg0->unk40 = (s32) (temp_4_147 + 1);
        }
        D_0015EE34 = arg0->unk40;
        if ((var_3_132 & 0x40) && (D_0013D290.unk8 == 2) && (*(s32 *)((u8 *)((arg0->unk40 * 0x1C) + &D_0013D290) + 0x20) >= 0)) {
