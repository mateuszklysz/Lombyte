...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/gameplay/camera/transition_update_movie_camera/FUN_001eaf88.s", FUN_001eaf88);
#else
#include "types.h"
...
void transition_update_movie_camera(void *a0) __asm__("FUN_001eaf88");

void transition_update_movie_camera(void *a0) {
