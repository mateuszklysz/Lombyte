...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/gameplay/camera/update_all_cameras/FUN_001ec420.s", FUN_001ec420);
#else
#include "types.h"
...
int update_all_cameras(void *a0, void *a1, void *a2, signed char a3) __asm__("FUN_001ec420");

int update_all_cameras(void *a0, void *a1, void *a2, signed char a3) {
    char buf[0x80];
    void *s2 = a1;
    void *s1 = a2;
    int idx = a3;
