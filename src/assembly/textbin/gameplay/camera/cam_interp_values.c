...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/gameplay/camera/cam_interp_values/FUN_001ebd78.s", FUN_001ebd78);
#else
#include "types.h"
extern s32 func_001F99C0();
f32 cam_interp_values(f32 *arg0, f32 fparg0, f32 fparg1, f32 fparg2, f32 fparg3, f32 fparg4) __asm__("FUN_001ebd78");

f32 cam_interp_values(f32 *arg0, f32 fparg0, f32 fparg1, f32 fparg2, f32 fparg3, f32 fparg4) {
    f32 temp_f14_18;
    f32 temp_f15_17;
    f32 temp_f1_15;
    f32 temp_f1_19;
