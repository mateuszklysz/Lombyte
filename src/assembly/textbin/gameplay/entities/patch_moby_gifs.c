...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/gameplay/entities/patch_moby_gifs/FUN_0020cef8.s", FUN_0020cef8);
#else
#include "types.h"
...
void patch_moby_gifs(char *a0) __asm__("FUN_0020cef8");

void patch_moby_gifs(char *a0) {
    char *a1 = a0;
    switch (*(int *)(a1 + 0x2C)) {
    case 0:
