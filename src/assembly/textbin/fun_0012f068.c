/* ROLE: recovered function `snd_InitMovieSound` (snd989, 0x40 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0012f068/FUN_0012f068.s", FUN_0012f068);
#else
#include "types.h"
