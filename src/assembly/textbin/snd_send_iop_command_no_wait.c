...
SYMBOL: snd_SendIOPCommandNoWait
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `snd_SendIOPCommandNoWait`. */

#include "types.h"
#include "asm.h"

#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/snd_send_iop_command_no_wait/FUN_0012e6e0.s", FUN_0012e6e0);
#else
#include "types.h"
...
void FUN_0012e6e0(void *a0, int a1) {
    char *s0 = (char *)a0;
    int s1 = a1;
    void *m;
    int val;
