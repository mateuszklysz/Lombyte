...
SYMBOL: memcard_RestoreData__FPcT0iP7mc_data
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered function `memcard_RestoreData__FPcT0iP7mc_data` starts here; this unit covers only its beginning. */

#include "types.h"
#include "asm.h"

#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0020af20/FUN_0020af20.s", FUN_0020af20);
#else
#include "types.h"
...
void FUN_0020af20(void *a0, int a1) {
    char *s0 = (char *)a0;
    int s1 = a1;
    void *m;
    int val;
