/* ROLE: recovered whole function `FontPrint` (fonts.cpp //). */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/font_print/FUN_001f62b0.s", FUN_001f62b0);
#else
#include "rnc/assembly_textbin_fun_001f62b0_types.h"
#include "types.h"
...
void FUN_001f62b0(char *dst, int type) {
    if (type < 7) {
        switch (type) {
        case 0:
