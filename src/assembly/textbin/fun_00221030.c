/* ROLE: recovered function `DrawCheatsMenu` (game/pause.cpp, 0x1918 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_00221030/FUN_00221030.s", FUN_00221030);
#else
#include "types.h"
...
void FUN_00221030(void *a0, int a1) {
    char *s0 = (char *)a0;
    int s1 = a1;
    void *m;
    int val;
