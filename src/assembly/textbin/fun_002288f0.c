/* ROLE: recovered function `DmaShrubTextures` (game/shrub something, 0x248 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_002288f0/FUN_002288f0.s", FUN_002288f0);
#else
#include "types.h"
