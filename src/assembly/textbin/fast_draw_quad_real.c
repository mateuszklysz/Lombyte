...
SYMBOL: FastDrawQuadReal
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `FastDrawQuadReal`. */

#include "types.h"
#include "asm.h"

#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fast_draw_quad_real/FUN_001f7d30.s", FUN_001f7d30);
#else
#include "types.h"
