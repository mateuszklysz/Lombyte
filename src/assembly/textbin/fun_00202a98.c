/* ROLE: recovered function `LoadHudBanks__Fv` (loaders.cpp, 0x278 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_00202a98/FUN_00202a98.s", FUN_00202a98);
#else
#include "types.h"
