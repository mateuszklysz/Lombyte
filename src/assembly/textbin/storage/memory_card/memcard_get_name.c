...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/storage/memory_card/memcard_get_name/FUN_00209030.s", FUN_00209030);
#else
#include "types.h"
...
void memcard_get_name(void *a0) __asm__("FUN_00209030");

void memcard_get_name(void *a0) {
