...
SYMBOL: Transition_FUN_001eb0a8
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered function `Transition_FUN_001eb0a8` starts here; this unit covers only its beginning. */
...
void *FUN_001eb0a8(int slot, int type) {
    char *r;
