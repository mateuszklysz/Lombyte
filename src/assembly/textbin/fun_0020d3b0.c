/* ROLE: recovered function `DrawMobysCleanUp` (mobyfunc, 0xb0 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0020d3b0/FUN_0020d3b0.s", FUN_0020d3b0);
#else
#include "types.h"
