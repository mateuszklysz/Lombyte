...
SYMBOL: voBufIncCount__FP5VoBuf
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `voBufIncCount__FP5VoBuf`. */

#include "types.h"
#include "asm.h"

#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/vo_buf_inc_count/FUN_0023d210.s", FUN_0023d210);
#else
#include "rnc/assembly_textbin_fun_0023d210_types.h"
#include "types.h"
