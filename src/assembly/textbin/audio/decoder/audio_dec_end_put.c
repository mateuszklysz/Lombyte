...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/audio/decoder/audio_dec_end_put/FUN_0023ae28.s", FUN_0023ae28);
#else
#include "rnc/assembly_textbin_fun_0023ae28_types.h"
#include "types.h"


void audio_dec_end_put(struct M2c_arg0 *arg0, s32 arg1) __asm__("FUN_0023ae28");

void audio_dec_end_put(struct M2c_arg0 *arg0, s32 arg1) {
    s32 temp_2_14;
    s32 temp_2_16;
    s32 temp_2_39;
    s32 temp_4_13;
