...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/audio/rpc/snd_send_iop_command_no_wait/FUN_0012e6e0.s", FUN_0012e6e0);
#else
#include "types.h"
...
void snd_send_iop_command_no_wait(void *a0, int a1) __asm__("FUN_0012e6e0");

void snd_send_iop_command_no_wait(void *a0, int a1) {
    char *s0 = (char *)a0;
    int s1 = a1;
    void *m;
    int val;
