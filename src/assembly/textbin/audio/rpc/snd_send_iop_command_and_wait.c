...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/audio/rpc/snd_send_iop_command_and_wait/FUN_0012e548.s", FUN_0012e548);
#else
#include "types.h"
...
int snd_send_iop_command_and_wait(char *a0) __asm__("FUN_0012e548");

int snd_send_iop_command_and_wait(char *a0) {
    void *m1;
    void *m2;
    int n;
