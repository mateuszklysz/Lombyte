...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/audio/music/process_bgm_display_text_event/FUN_001f6638.s", FUN_001f6638);
#else
#include "types.h"
...
int process_bgm_display_text_event(char *s1) __asm__("FUN_001f6638");

int process_bgm_display_text_event(char *s1) {
    short i;
    int flags;
    long t;
    void (*cb)();
