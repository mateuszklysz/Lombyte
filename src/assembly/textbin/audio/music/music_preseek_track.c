...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/audio/music/music_preseek_track/FUN_00215b68.s", FUN_00215b68);
#else
#include "types.h"
...
void music_preseek_track(s32 track, s32 arg1, s32 arg2) __asm__("FUN_00215b68");

void music_preseek_track(s32 track, s32 arg1, s32 arg2) {
    volatile s32 *entry;
    s64 v;
    ...
    if (*entry != 0) {
        *(u32 *)&D_001516D0.unk34 = 0xFFFFFFFF;
        ...
        v = *entry;
        func_0012EC08(v, 0, 0, 0, arg2, 0, 1, 0, 0x21, func_00216A20, (u32)&D_001516D0.unk34);
    }
}
#endif /* NON_MATCHING */
