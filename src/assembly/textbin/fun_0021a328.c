...
#else
#include "rnc/assembly_textbin_fun_0021a328_types.h"
#include "types.h"
...
extern s32 func_001FECC8();
extern s32 func_0021B6D8();
extern s32 func_00233980();
extern s32 memset();
extern s32 sprintf();
s32 FUN_0021a328(struct M2c_arg0 *arg0) {    u16 sp4E;
u8 sp_slot[0x120];    s16 sp40;
    s16 sp42;                                       /* compiler-managed */
    u16 sp44;                                       /* compiler-managed */
    u16 sp46;
    u16 sp48;
    u16 sp4A;
    u16 sp52;
    ...
    if (temp_5_41 & 0x20) {
        ...
        arg0->unk48 = 0U;
        arg0->unk4C = 0;
    } else if (temp_5_41 & 0x80) {
        var_18_49 = D_001D5BF4[0]->unk40->unk40;
        if (temp_5_41 & 0x8000) {
            var_2_84 = D_0015ED80;
            goto block_26;
        }
    } else if (temp_5_41 & 0x100) {
...
block_26:
    ...
    if (temp_3_200 & 4) {
        ...
        /* Duplicate return node #83. Try simplifying control flow for better match */
        return var_2_206;
    }
    if (temp_3_200 & 0x1000) {
        var_4_204 = arg0->unk34;
        if (var_4_204 == 0xFFFF) {
            return 1;
        }
    ...
    if ((temp_3_200 & 0x100) && (var_18_49 == -1U)) {
...
block_61:
    ...
    func_001F4280(0);
    temp_21_341 = func_001F44B8(var_20_10);
    memset(&sp60, 0, 0x18);
    ...
    sp60 = D_00160258;
    /* m2c-unknown:  unknown instruction: ldl $v0, 0x67($sp_slot)  */
    /* m2c-unknown:  unknown instruction: ldr $v0, 0x60($sp_slot)  */
    /* m2c-unknown:  unknown instruction: ldl $a0, 0x6f($sp_slot)  */
    /* m2c-unknown:  unknown instruction: ldr $a0, 0x68($sp_slot)  */
    /* m2c-unknown:  unknown instruction: ldl $a1, 0x77($sp_slot)  */
    /* m2c-unknown:  unknown instruction: ldr $a1, 0x70($sp_slot)  */
    /* m2c-unknown:  unknown instruction: sdl $v0, 0x47($sp_slot)  */
    /* m2c-unknown:  unknown instruction: sdr $v0, 0x40($sp_slot)  */
    /* m2c-unknown:  unknown instruction: sdl $a0, 0x4f($sp_slot)  */
    /* m2c-unknown:  unknown instruction: sdr $a0, 0x48($sp_slot)  */
    /* m2c-unknown:  unknown instruction: sdl $a1, 0x57($sp_slot)  */
    /* m2c-unknown:  unknown instruction: sdr $a1, 0x50($sp_slot)  */
    if (arg0->unk30 & 0x10000) {
        sp42 = temp_11_346 - 1;
    }
    temp_16_395 = func_0021B6D8(arg0->unk44, func_001FA6E0(D_001601B0, 0x80FFA888, temp_6_355, D_00160268, D_00160258, 0x10000, 1, temp_11_346, 0x3F000000), 0x80FFA888);
    temp_5_398 = temp_16_395;
    sp52 |= 4;
    func_001F7090(&sp40, temp_5_398, var_19_12, -1, temp_21_341, var_23_8);
    ...
    func_001F7090(&sp40, 0x8000 << 0x10, var_19_12, -1, temp_21_341, var_23_8);
    func_001F61E8();
    ...
    sp44 -= D_001601B8;
    sp48 = temp_10_489;
    func_001F7090(&sp40, temp_16_395, var_19_12, -1, temp_21_341, var_23_8, temp_10_489, temp_11_486);
    if (arg0->unk30 & 0x400) {
        ...
        sp48 = temp_10_556;
        func_001F7090(&sp40, temp_16_395, var_19_12, -1, temp_21_341, var_23_8, temp_10_556, temp_11_553);
        if (arg0->unk30 & 0x400) {
...
extern s32 func_0021A328(struct M2c_arg0 *arg0) __attribute__((alias("FUN_0021a328")));
#endif /* NON_MATCHING */
