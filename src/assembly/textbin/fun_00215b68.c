/* ROLE: recovered function `music_PreseekTrack__Fiii` (music.cpp, 0xd8 bytes) starts here; this unit covers only its first fragment. */
...
void FUN_00215b68(u16 arg0, u16 arg1, u16 arg2) {
    s32 *temp_4_18;
    ...
    if (D_001516D0.unk34 == 0) {
        ...
        if (*temp_4_18 != 0) {
            ...
            D_001516D0.unk44 = 0;
            func_0012EC08((s64) ((s64) *temp_4_18 << 0x20) >> 0x20, 0, 0, 0, arg2, 0, 1, 0, 0x21, &func_00216A20, (u64) ((s64) (((u8 *)&D_001516D0 + 0x34)) << 0x20) >> 0x20);
        }
    }
}
#endif /* NON_MATCHING */
