/* ROLE: recovered function `PatchMobyGifs` (game/initonce.cpp, 0xab38 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0020cef8/FUN_0020cef8.s", FUN_0020cef8);
#else
#include "types.h"
