...
SYMBOL: BuildOcclVisibility__Fv
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `BuildOcclVisibility__Fv`. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/build_occl_visibility/FUN_001f2820.s", FUN_001f2820);
#else
#include "types.h"
...
void *FUN_001f2820(int slot, int type) {
    char *r;
