...
#else
#include "rnc/assembly_textbin_fun_001fde90_types.h"
#include "types.h"
            ...
            case 4:
                ...
                if (D_0013CAE4[0] & 0x10) {
                    ...
                    *temp_5_490 = *temp_5_490 | (1 << D_0015ED84[0]) | 0x80000000;
                    temp_19_440->unk4 = (s32) (4 - (u32)temp_19_440->unk4);
                } else {
...
extern void func_001FDE90(void) __attribute__((alias("FUN_001fde90")));
#endif /* NON_MATCHING */
