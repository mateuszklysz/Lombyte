/* ROLE: recovered function `memcard_GetName` (game/initonce.cpp, 0x268 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_00209030/FUN_00209030.s", FUN_00209030);
#else
#include "types.h"
