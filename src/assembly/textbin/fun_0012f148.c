/* ROLE: recovered function `snd_UpdateMovieADPCM` (snd989, 0x30 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0012f148/FUN_0012f148.s", FUN_0012f148);
#else
#include "types.h"
