/* ROLE: recovered function `SkyDrawShellGouraud` (skyfunc) starts here; recovered extent unknown. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0022b928/FUN_0022b928.s", FUN_0022b928);
#else
#include "types.h"
