...
SYMBOL: mpegError__FP7sceMpegP18sceMpegCbDataErrorPv
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/mpeg_error/FUN_0023d080.s", FUN_0023d080);
#else
#include "types.h"
