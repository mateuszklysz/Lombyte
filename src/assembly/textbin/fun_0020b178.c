...
SCORE: code=66.83448 functions=66.83448 data=100 complete_data=100
DECISION: retained
...
block_4:
    return arg0 == 0;
block_5:
    temp_2_43 = D_0013D290.unkF4 | arg0;
    D_0013D290.unkF4 = temp_2_43;
    if (temp_2_43 == 0) {
        goto block_18;
    }
    if (arg0 != 0) {
...
block_8:
    ...
    var_18_63 = 0;
    D_0013D290.unkC8 = (s32) D_0015ED84;
    if (arg1 < 0) {
        goto block_13;
    }
    D_0015ED84 = arg1;
...
block_14:
    ...
    *(D_0015ED84 + D_0013DD58) = var_18_63;
    D_0015ED84 = D_0013D290.unkC8;
block_16:
    if (D_0013D290.unkDC >= 0) {
        goto block_19;
    }
