/* ROLE: recovered whole function `DrawTies_1` (tiefunc). */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/draw_ties_1/FUN_002358c8.s", FUN_002358c8);
#else
#include "types.h"
