...
SYMBOL: FUN_00220850
SCORE: code=61.627777 functions=61.627777 data=100 complete_data=100
DECISION: retained
...
s32 FUN_00220850(s32 arg2) {
    ...
    if (D_001A00F0.unk228 >= 0) {
        if ((D_001A00F0.unk228 == 6) || (D_001A00F0.unk228 == 0xD) || (var_6_0 = 0x2AB, (D_001A00F0.unk228 == 0x11))) {
            ...
            func_00233980(8, 0);
            func_00200468(D_001A00F0.unk258, temp_17_109, temp_17_109, 7, 7, (D_00151780.unk160 * 0x10) - temp_18_116, (D_00151780.unk162 * 0x10) - temp_18_116, temp_7_111 - (((s32) ((temp_8_113 != 0) ? temp_7_111 : (temp_7_111 + 0x7FF)) >> 0xB) << 0xB), 0, 0x80);
            func_00233980(0x47, 0x360B);
            func_00233980(8, 5);
            func_00200468(D_001A00F0.unk260, temp_17_109, temp_17_109, 7, 7, (D_00151780.unk160 * 0x10) - temp_18_116, (D_00151780.unk162 * 0x10) - temp_18_116, 0, 0, 0x80);
            func_00200468(D_001A00F0.unk268, temp_17_109, temp_17_109, 7, 7, (D_00151780.unk160 * 0x10) - temp_18_116, (D_00151780.unk162 * 0x10) - temp_18_116, 0, 0, 0x80);
        }
        var_2_16 = 4;
    }
    return var_2_16;
