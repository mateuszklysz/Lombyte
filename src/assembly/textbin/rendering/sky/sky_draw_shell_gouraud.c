...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/rendering/sky/sky_draw_shell_gouraud/FUN_0022b928.s", FUN_0022b928);
#else
#include "types.h"
...
void sky_draw_shell_gouraud(char *s0) __asm__("FUN_0022b928");

void sky_draw_shell_gouraud(char *s0) {
    char st;
