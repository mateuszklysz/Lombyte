...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/rendering/view/build_look_at_matrix/FUN_00214890.s", FUN_00214890);
#else
#include "types.h"
...
void build_look_at_matrix(void *dst, void *a1, void *a2, void *a3) __asm__("FUN_00214890");

void build_look_at_matrix(void *dst, void *a1, void *a2, void *a3) {
    char M[0x40];
    char Tv[0x10];
    sceVu0UnitMatrix(M);
