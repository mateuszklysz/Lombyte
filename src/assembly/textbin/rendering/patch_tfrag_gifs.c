...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/rendering/patch_tfrag_gifs/FUN_00233308.s", FUN_00233308);
#else
#include "types.h"
...
void patch_tfrag_gifs(int *a0) __asm__("FUN_00233308");

void patch_tfrag_gifs(int *a0) {
    char *p;
    int f;
    long t;
    p = D_00747A78;
