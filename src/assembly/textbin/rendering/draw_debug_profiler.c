...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/rendering/draw_debug_profiler/FUN_001f39d0.s", FUN_001f39d0);
#else
...
extern void func_001F2C10(void);
...
extern void func_00235840(void);
extern void func_00235898(void);
