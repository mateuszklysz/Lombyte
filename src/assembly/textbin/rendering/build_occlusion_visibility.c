...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/rendering/build_occlusion_visibility/FUN_001f2820.s", FUN_001f2820);
#else
#include "types.h"
...
void *build_occlusion_visibility(int slot, int type) __asm__("FUN_001f2820");

void *build_occlusion_visibility(int slot, int type) {
    char *r;
