...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/rendering/create_point_light/FUN_00201ba8.s", FUN_00201ba8);
#else
#include "types.h"
...
void create_point_light(void *a0) __asm__("FUN_00201ba8");

void create_point_light(void *a0) {
    char *s1 = (char *)a0;
    int *p;
    int i;
    unsigned long t;
