...
SYMBOL: snd_SetReverbEx
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `snd_SetReverbEx`. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/snd_set_reverb_ex/FUN_0012ef68.s", FUN_0012ef68);
#else
#include "types.h"
