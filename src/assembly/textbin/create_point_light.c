...
SYMBOL: CreatePointLight
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `CreatePointLight`. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/create_point_light/FUN_00201ba8.s", FUN_00201ba8);
#else
#include "types.h"
