/* ROLE: recovered function `DrawMobys` (mobyfunc, 0x7c0 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0020d460/FUN_0020d460.s", FUN_0020d460);
#else
#include "types.h"
