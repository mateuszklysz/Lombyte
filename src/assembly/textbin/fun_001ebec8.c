...
SYMBOL: Camera_runSetupToNewCam__FP9UpdateCam
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_001ebec8/FUN_001ebec8.s", FUN_001ebec8);
#else
#include "types.h"
...
Sint32 FUN_001ebec8(Sint32 ptid, Sint32 flid) {
    ADXF_PTINFO *info;
