...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/world/transforms/build_object_rotation_matrix/FUN_0022de10.s", FUN_0022de10);
#else
...
extern void SceVu0RotMatrixX();
extern void SceVu0RotMatrixY();
extern void func_001F2D98();
extern void func_001F9AD8();
extern void sceVu0RotMatrixZ();
extern void sceVu0UnitMatrix();
u8 build_object_rotation_matrix(void) __asm__("FUN_0022de10");

u8 build_object_rotation_matrix(void) {    s32 sp0;
