/* ROLE: recovered whole function `FastVecDot` (fastfunc.s). */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fast_vec_dot/FUN_001f9ab0.s", FUN_001f9ab0);
#else
#include "types.h"
...
float FUN_001f9ab0(void *a0, void *a1) {
    float r;
    int t;
    VU0_LQC2(4, a0, 0);
    VU0_LQC2(5, a1, 0);
