...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_00209370/FUN_00209370.s", FUN_00209370);
#else
#include "rnc/assembly_textbin_fun_00209370_types.h"
#include "types.h"
