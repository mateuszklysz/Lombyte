...
SYMBOL: Camera_ActivationCheckPriority
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered function `Camera_ActivationCheckPriority` starts here; this unit covers only its beginning. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_001ec210/FUN_001ec210.s", FUN_001ec210);
#else
#include "types.h"
...
void FUN_001ec210(void *a0, int a1) {
    char *s0 = (char *)a0;
    int s1 = a1;
    void *m;
    int val;
