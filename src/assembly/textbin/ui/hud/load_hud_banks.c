...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/ui/hud/load_hud_banks/FUN_00202a98.s", FUN_00202a98);
#else
#include "types.h"
...
void load_hud_banks(char *s0) __asm__("FUN_00202a98");

void load_hud_banks(char *s0) {
    char st;
