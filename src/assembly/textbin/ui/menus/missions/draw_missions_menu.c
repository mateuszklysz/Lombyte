...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/ui/menus/missions/draw_missions_menu/FUN_0021f368.s", FUN_0021f368);
#else
...
s32 draw_missions_menu(struct M2c_arg0 *arg0) __asm__("FUN_0021f368");

s32 draw_missions_menu(struct M2c_arg0 *arg0) {
    s32 temp_16_119;
    s32 temp_16_128;
    s32 temp_16_139;
    s32 temp_16_24;
