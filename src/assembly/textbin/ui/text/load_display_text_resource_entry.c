...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/ui/text/load_display_text_resource_entry/FUN_00214bc0.s", FUN_00214bc0);
#else
#include "types.h"
...
void load_display_text_resource_entry(void *a0) __asm__("FUN_00214bc0");

void load_display_text_resource_entry(void *a0) {
    char *s = (char*)a0;
