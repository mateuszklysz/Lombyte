/* ROLE: recovered function `memcard_RestoreInfo__FPcii` (game/initonce.cpp, 0xc0 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0020ae60/FUN_0020ae60.s", FUN_0020ae60);
#else
#include "types.h"
