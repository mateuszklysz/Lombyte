...
#else
#include "rnc/assembly_textbin_fun_00205640_types.h"
#include "types.h"
...
void FUN_00205640(void) {
    ...
    struct M2c_var_19_691 *var_19_691;
    struct M2c_var_4_740 *var_4_740;
    struct M2c_var_6_566 *var_6_566;
    f32 var_f21_999;
    ...
    if (((struct M2c_D_001A00F0 *)&D_001A00F0)->unk228 >= 0) {
        ...
        if ((((struct M2c_D_001A00F0 *)&D_001A00F0)->unk2C != 0) && (((struct M2c_D_001A00F0 *)&D_001A00F0)->unk8 != 0)) {
            ...
            do {
                ...
                if (temp_5_333 >= 0) {
                    ...
                    func_00200E08(spA0 + ((s32) ((temp_10_345 > -1) ? temp_10_345 : (temp_10_345 + 0xF)) >> 4), spA4 + ((s32) ((temp_4_342 > -1) ? temp_4_342 : (temp_4_342 + 0xF)) >> 4), spA0 + ((s32) ((temp_11_353 > -1) ? temp_11_353 : (temp_11_353 + 0xF)) >> 4), spA4 + ((s32) ((temp_6_346 > -1) ? temp_6_346 : (temp_6_346 + 0xF)) >> 4), 0x20000000, 1);
                }
                var_19_327 -= 1;
                var_20_323 += 0x10;
            } while (var_19_327 >= 0);
        ...
        if (((struct M2c_D_001A00F0 *)&D_001A00F0)->unk20 != NULL) {
            ...
            if (!(((struct M2c_D_001A00F0 *)&D_001A00F0)->unk20->unk2C & 4)) {
                ...
                do {
                    ...
                    if (temp_3_543->unk24 != 0) {
                        ...
                        } else if (temp_3_543->unk4 & 3) {
                            var_5_536 = temp_17_546;
                        } else if (*(s32 *)((u8 *)((temp_17_546 * 0x28) + ((struct M2c_D_001A00F0 *)&D_001A00F0)->unk20) + 0x4) & 4) {
                            var_5_536 = temp_17_546;
                        } else {
...
block_58:
                            ...
                            if (temp_18_704 != 0) {
                                ...
                                if (temp_3_741 & 0x100) {
                                    ...
                                    if (temp_3_741 & 0x400) {
                                        ...
                                        var_f23_749 = var_f20_733 * D_0015FD8C;
                                    ...
                                    if (*(s32 *)((u8 *)(var_22_693 + ((struct M2c_D_001A00F0 *)&D_001A00F0)->unk20) + 0x4) & 0x800) {
                                        ...
                                        var_f23_749 = var_f20_733 * D_0015FD84;
                                        if (*(s32 *)(D_0013D5BC + (*(s16 *)((u8 *)(var_22_693 + ((struct M2c_D_001A00F0 *)&D_001A00F0)->unk20)) * 0x10)) & 2) {
                                            var_16_706 = var_16_706 + 1;
                                        }
                                    }
                                ...
                                if (temp_3_865->unk4 & 0x10) {
                                    ...
                                    temp_16_922 = var_18_909 + temp_5_876;
        ...
        if (D_0015ED84 == ((struct M2c_D_001A00F0 *)&D_001A00F0)->unk228) {
...
extern void func_00205640(void) __attribute__((alias("FUN_00205640")));
#endif /* NON_MATCHING */
