/* ROLE: recovered function `snd_CloseMovieSound` (snd989, 0x28 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0012f0e0/FUN_0012f0e0.s", FUN_0012f0e0);
#else
#include "types.h"
