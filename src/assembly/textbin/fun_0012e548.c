...
SYMBOL: snd_SendIOPCommandAndWait
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered function `snd_SendIOPCommandAndWait` starts here; this unit covers only its beginning. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0012e548/FUN_0012e548.s", FUN_0012e548);
#else
#include "types.h"
