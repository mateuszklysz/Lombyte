...
SYMBOL: snd_StreamSafeCdRead
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered whole function `snd_StreamSafeCdRead`. */

#include "types.h"
#include "asm.h"

#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/snd_stream_safe_cd_read/FUN_0012ed58.s", FUN_0012ed58);
#else
#include "types.h"
