...
void FUN_00215440(u16 arg0, u16 arg1, u16 arg2) {
    s32 temp_4_16;

    temp_4_16 = *(s32 *)((u8 *)(D_00137B80 + ((arg0 + 0xFFFF15A0) * 8)) + 0x1618);
    if (temp_4_16 != 0) {
        if (D_001516D0.unk50 == 0) {
            ...
            D_001516D0.unk60 = 0;
            func_0012EC08(temp_4_16, 0, 0, 0, arg2, 0, 2, 0, 0x21, &func_002169C0, (u64) ((s64) (((u8 *)&D_001516D0 + 0x50)) << 0x20) >> 0x20);
        }
    }
}
#endif /* NON_MATCHING */
