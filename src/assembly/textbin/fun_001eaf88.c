...
SYMBOL: Transition_UpdateMovieCamera__Fv
SCORE: code=100 functions=100 data=100 complete_data=100
DECISION: retained (pending)
*/

/* ROLE: recovered function `Transition_UpdateMovieCamera__Fv` starts here; this unit covers only its beginning. */

#include "types.h"
#include "asm.h"

#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_001eaf88/FUN_001eaf88.s", FUN_001eaf88);
#else
#include "types.h"
