/* ROLE: recovered function `DrawGBsShipMenu__maybe` (game/pause.cpp, 0x3f0 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0021ef78/FUN_0021ef78.s", FUN_0021ef78);
#else
#include "types.h"
