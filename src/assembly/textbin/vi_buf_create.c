/* ROLE: recovered whole function `viBufCreate` (movie/vibuf.cpp). */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/vi_buf_create/FUN_0023bc48.s", FUN_0023bc48);
#else
