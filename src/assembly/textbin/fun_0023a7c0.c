/* ROLE: recovered function `initAll__Fiii` (movie/movie.cpp, 0x2a8 bytes) starts here; this unit covers only its first fragment. */
...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/fun_0023a7c0/FUN_0023a7c0.s", FUN_0023a7c0);
#else
#include "types.h"
