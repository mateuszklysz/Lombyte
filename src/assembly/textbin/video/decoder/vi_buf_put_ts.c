...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/video/decoder/vi_buf_put_ts/FUN_0023c810.s", FUN_0023c810);
#else
#include "types.h"
...
void vi_buf_put_ts(char *p) __asm__("FUN_0023c810");

void vi_buf_put_ts(char *p) {
    char *r;
    char *q;
    int t0;
    int t1;
