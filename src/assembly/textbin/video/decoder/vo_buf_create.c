...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/video/decoder/vo_buf_create/FUN_0023d190.s", FUN_0023d190);
#else
#include "types.h"
...
void vo_buf_create(void *a0, int a1) __asm__("FUN_0023d190");

void vo_buf_create(void *a0, int a1) {
    char *p = (char *)a0;
    int i;
    int *q;
    *(int *)(p + 0x4) = 0;
