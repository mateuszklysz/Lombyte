...
#ifndef NON_MATCHING
INCLUDE_ASM("config/us/expected/asm/assembly/textbin/video/decoder/vo_buf_inc_count/FUN_0023d210.s", FUN_0023d210);
#else
...
void vo_buf_inc_count(void) __asm__("FUN_0023d210");

void vo_buf_inc_count(void) {
    ThreadParam param;
