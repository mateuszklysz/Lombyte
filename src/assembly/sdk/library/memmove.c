...
#ifndef NON_MATCHING
/* Exact SDK/library unit memmove; symbolic expected assembly retained pending source recovery. */
INCLUDE_ASM("config/us/expected/asm/assembly/sdk/library/memmove/memmove.s", memmove);
#else
#include "types.h"
