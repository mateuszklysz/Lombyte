...
#ifndef NON_MATCHING
/* Exact SDK/library unit _extensionAndUserData; symbolic expected assembly retained pending source recovery. */
INCLUDE_ASM("config/us/expected/asm/assembly/sdk/library/_extensionAndUserData/_extensionAndUserData.s", _extensionAndUserData);
#else
#include "types.h"
...
int _extensionAndUserData(void *a0) {
    char *s2 = (char *)a0;
