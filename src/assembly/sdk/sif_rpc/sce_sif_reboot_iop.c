...
#ifndef NON_MATCHING
/* Exact SDK/library unit sceSifRebootIop; symbolic expected assembly retained pending source recovery. */
INCLUDE_ASM("config/us/expected/asm/assembly/sdk/sif_rpc/sce_sif_reboot_iop/sceSifRebootIop.s", sceSifRebootIop);
#else
#include "types.h"
