...
#ifndef NON_MATCHING
/* Exact second Sony DMAC setD4_CHCR body; target-derived variant. */
__asm__(
    ".set noreorder\n"
    ".text\n"
    ".align 3\n"
    ".globl SetD4ChcrVariant\n"
    ".type SetD4ChcrVariant, @function\n"
    "SetD4ChcrVariant:\n"
    ".word 0x27BDFFE0\n"
    ".word 0xFFB00000\n"
    ".word 0xFFBF0010\n"
    ...
    "j EnableInterrupts\n"
    ".word 0x27BD0020\n"
    ".size SetD4ChcrVariant, .-SetD4ChcrVariant\n"
    ".set reorder\n"
);
#else
#include "types.h"
