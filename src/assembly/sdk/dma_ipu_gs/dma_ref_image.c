...
#ifndef NON_MATCHING
/* Exact SDK/library unit dmaRefImage; symbolic expected assembly retained pending source recovery. */
INCLUDE_ASM("config/us/expected/asm/assembly/sdk/dma_ipu_gs/dma_ref_image/dmaRefImage.s", dmaRefImage);
#else
#include "types.h"
