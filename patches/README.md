...
| `sce-991111b` | Sony/Cygnus EE 2.9-ee-991111b | recovered archive, see [`sce-991111b/README.md`](sce-991111b/README.md) | none yet | full source available; binary scores worse than SN on most units |
