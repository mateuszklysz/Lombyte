<p align="center">
  <img src="assets/lombyte-logo.svg" alt="Lombyte" width="480">
</p>
...
| [`assets/`](assets/) | Original Lombyte banner and generated progress map |
...
The Lombyte banner in [`assets/`](assets/) is original artwork generated by [`scripts/generate_logo.py`](scripts/generate_logo.py); the original game's assets, logo, and trademarks belong to their respective owners.
