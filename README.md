...
The table is a dated snapshot; the map above is regenerated by the maintainers whenever promotions land. Percentages describe the configured code in the boot executable, not the entire disc or all game content.
