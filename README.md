...
**Decompilation snapshot**

| Measure | Status |
| :--- | :--- |
| Matching C functions | **354** — approximately **26.1%** of configured functions |
| Matching C code size | **36,500 bytes** — **8.47%** of configured code bytes |
...
The table is a snapshot; the map above is regenerated by the maintainers whenever promotions land. Percentages describe the configured code in the boot executable, not the entire disc or all game content.
